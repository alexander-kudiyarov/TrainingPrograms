...
namespace Core.TrainingPrograms
{
    public sealed class PullAndSquatProgram : BaseTrainingProgram
    {
        ...
        private static Session GetSession4_3()
        {
            ...
            var ex2 = new Snatch(MuscleSnatch, SnatchBalance)
            {
                Repeats = new Repeat[]
                {
            ...
            var ex3 = new Snatch(SnatchPull, HangSnatchPullBelowKnee)
            {
                Repeats = new Repeat[]
                {
                    new MultiRepeat {Percent = 0.7, Repeats = new[] {1, 3}},
                    new MultiRepeat {Percent = 0.8, Repeats = new[] {1, 3}, Sets = 2},
                    new MultiRepeat {Percent = 0.9, Repeats = new[] {1, 2}, Sets = 2},
                    new MultiRepeat {Percent = 1.0, Repeats = new[] {1, 1}, Sets = 2},
        ...
        private static Session GetSession5_2()
        {
            ...
            var ex3 = new Snatch(SnatchPushPress, OverheadSquat)
            {
                Repeats = new Repeat[]
                {
        ...
        private static Session GetSession5_3()
        {
            ...
            var ex3 = new CleanAndJerk(DeficitCleanPull)
            {
                Repeats = new Repeat[]
                {
                    ...
                    new SingleRepeat {Percent = 1.0, Repeats = 3, Sets = 2},
                    new SingleRepeat {Percent = 1.05, Repeats = 2, Sets = 2},
                    new SingleRepeat {Percent = 1.1, Repeats = 1}
                }
            };
